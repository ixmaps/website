...
<dl>
  ...
  <dt>What is network sovereignty?</dt> 
...
<br> See <a href="sovereignty.php">our Showcase Routes section on network sovereignty</a> for more details.</dd>
  ...
  <dt>What are NSA listening posts?</dt> 
  <dd>The U.S. National Security Agency (NSA), is strongly suspected of having installed &lsquo;splitter rooms&rsquo; in 15-20 major internet exchange points.</dd>
  <dd><a href="https://spreadsheets.google.com/spreadsheet/ccc?key=0Aiub6gMLPmfYdGp3VzBRWU1kSnNhbWNqaHRFVlNCcWc&hl=en_US&authkey=CMeo8ZkG">View a summary</a> of the evidence supporting our claims regarding NSA splitter locations.</dd>
  
  <dt>Who are our some of our principal sources of research related to the NSA?</dt> 
  <dd>Both <a href="http://en.wikipedia.org/wiki/Mark_Klein" target="_blank">Mark Klein</a> and <a href="http://en.wikipedia.org/wiki/James_Bamford" target="_blank">James Bamford</a> have been instrumental in spotlighting the activities of the NSA. The <a href="http://www.eff.org/" target="_blank">Electronic Frontier Foundation</a> has been at the forefront of promoting transparency. This information has also been reviewed in an article from <a href="http://www.salon.com/news/feature/2006/06/21/att_nsa/print.html" target="_blank">Salon</a> and discussed in a <a href="http://www.pbs.org/wgbh/pages/frontline/homefront/interviews/klein.html" target="_blank">PBS documentary</a>  </dd>

  <dt>What kinds of resources did we use on telecommunications infrastructures?</dt> 
  <dd>Although harder to find these days, we have located several AT&T fibre 'backbone maps'.
  These range in date from 2000 to 2008, covering the relevant time span in regards to the NSA.
  See <a href="http://www.corp.att.com/globalnetworking/media/network_map.swf" target="_blank">1</a>, <a href="http://www.planetdds.com/downloads/ATT_IDC_Irvine.pdf" target="_blank">2</a>,
<a href="http://personalpages.manchester.ac.uk/staff/m.dodge/cybergeography/atlas/att_backbone_large.gif" target="_blank">3</a>. 
We also looked at several sources regarding the largest cable hubs in North America, such as <a href="http://www.sciencedaily.com/releases/2002/11/021126072153.htm" target="_blank">this</a> article. Finally, we looked at several sites that measure performance/latency, managed by <a href="http://www.akamai.com/html/technology/dataviz1.html" target="_blank">Akamai</a> and <a href="http://ipnetwork.bgtmo.ip.att.net/pws/current_network_performance.shtml" target="_blank">AT&T.</a> We also compiled a <a href="http://dev.ixmaps.ischool.utoronto.ca/cgi-bin/ge-render.cgi?show_landing_sites=true">mapping </a>of undersea cable sites.
  </dd>

  <dt>How do we geolocate routers?</dt> 
  <dd>In order to map the generated traceroutes on Google Earth, we must ascertain the physical location of the routers that generate the IP addresses in the route. When a traceroute is run, our software assigns locations to the IP addresses using a commercial service called <a href="http://www.maxmind.com" target=_blank">Maxmind</a>. This is often sufficient to geolocate the router to within about 5km of the target. However, Maxmind tends to work best when locating edge routers; its success rate when attempting to geolocate core routers drops to nearly zero. Therefore, we have adopted a layered strategy to manually assign physical locations to core routers. This methodology is explained in some technical detail <a href="technical.php">here</a>.
	...
	<h3>Glossary</h3><br>
                <ul class="nobullet">
                      ...
                      <li><a href="#ASNumber">AS Number</a></li>
