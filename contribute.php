...
<!-- 			<div class="announcement">Please try out a preview version of our updated TrGen software for
			...
			<p><a href="https://www.ixmaps.ca/TrGen/IXmapsClient_v.1.0.dmg">Download the installer from here - IXmapsClient_linux_v.1.0.zip</a> and follow the instructions in the ReadMe file. You will need administrator privileges to run and install the software. </p>
