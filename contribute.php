  ...
  <section id="container"><!-- #container -->
    <section id="content"><!-- #content -->
      ...
      <article>
        ...
        <p><a href="https://www.ixmaps.ca/IXmapsClient/IXmapsClient.1.0.6.win64.exe">Download the installer - IXmapsClient.1.0.6.win64.exe</a> and follow the instructions in the ReadMe file. You will need administrator privileges to run and install the software.</p>

        <h4>Mac OSX installation</h4>
        <ul class="nobullet">
          <li><a href="https://www.ixmaps.ca/IXmapsClient/IXmapsClient_v.1.0.6.macos.dmg">Download the installer - IXmapsClient_v.1.0.6.macos.dmg</a> and follow the instructions in the ReadMe file. You will need administrator privileges to run and install the software. You may also need to adjust your privacy and security settings to allow installing applications downloaded from the internet.</li>
          <li>(Requires Mac OSX v10.6 or higher - tested on 10.6.8, 10.7.5, 10.8, 10.10)</li>
        </ul>

        <h4>Linux installation</h4>
        <p><a href="https://www.ixmaps.ca/IXmapsClient/IXmapsClient.1.0.6.linux.tar.gz">Download the installer - IXmapsClient.1.0.6.linux.tar.gz</a> and follow the instructions in the ReadMe file. You will need administrator privileges to run and install the software.</p>
