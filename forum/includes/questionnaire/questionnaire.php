	...
	*/
	function get_data()
	{
		return array(
			...
			'allow_url_fopen'../../../phpBB3/includes/questionnaire/				=> (int) @ini_get('allow_url_fopen'),
			'allow_url_include'../../../phpBB3/includes/questionnaire/				=> (int) @ini_get('allow_url_include'),
...
class phpbb_questionnaire_phpbb_data_provider
{
	...
	*/
	function get_data()
	{
		...
		include("../../../phpBB3/includes/questionnaire/{$phpbb_root_path}config.$phpEx");
