...
class template_compile
{
	...
	*/
	function compile_tag_block($tag_args)
	{
		...
		{
			// Block is not nested.
			$tag_template_php = '$_' . $tag_args . "_count = (isset(\$this->_tpldata['../../phpBB3/includes/$tag_args'])) ? sizeof(\$this->_tpldata['../../phpBB3/includes/$tag_args']) : 0;";
			$varref = "\$this->_tpldata['../../phpBB3/includes/$tag_args']";
		}
		else
		{
	...
	*/
	function compile_tag_include($tag_args)
	{
		...
		return "\$this->_tpl_include('../../phpBB3/includes/$tag_args');";
	}
	...
	*/
	...
	{
		return "\$this->_php_include('../../phpBB3/includes/$tag_args');";
	}
