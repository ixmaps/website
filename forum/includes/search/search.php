	...
	*/
	function get_ignore_words()
	{
		if (!sizeof($this->ignore_words))
		{
			...
			if (file_exists("../../../phpBB3/includes/search/{$user->lang_path}{$user->lang_name}/search_ignore_words.$phpEx"))
			{
				// include the file containing ignore words
				include("../../../phpBB3/includes/search/{$user->lang_path}{$user->lang_name}/search_ignore_words.$phpEx");
			}
	...
	*/
	function get_synonyms()
	{
		if (!sizeof($this->match_synonym))
		{
			...
			if (file_exists("../../../phpBB3/includes/search/{$user->lang_path}{$user->lang_name}/search_synonyms.$phpEx"))
			{
				// include the file containing synonyms
				include("../../../phpBB3/includes/search/{$user->lang_path}{$user->lang_name}/search_synonyms.$phpEx");
			}
