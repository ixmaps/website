...
class acp_search
{
	...
	*/
	function init_search($type, &$search, &$error)
	{
		...
		if (!preg_match('#^\w+$#', $type) || !file_exists("../../../phpBB3/includes/acp/{$phpbb_root_path}includes/search/$type.$phpEx"))
		{
			$error = $user->lang['NO_SUCH_SEARCH_MODULE'];
			return $error;
		}

		include_once("../../../phpBB3/includes/acp/{$phpbb_root_path}includes/search/$type.$phpEx");
